...
export default function Result(props){
    ...
    const { narrowURL, SendSMS, setShowQR, setShowSMS } = props;
    ...
    return (
        <section className="resultState animated-fadeIn">
            <section className="headerContainer">
                ...
                <h1 className="header-title">Shortened URL is Ready</h1>
            </section>
            ...
            <section className="linkContainer">
                ...
                <h1 className="link">
                    {narrowURL}
                    <img src={CopyIcon} alt="copy-icon" className="copy-icon" onClick={CopyShortenedURL} />
                </h1>
            </section>
